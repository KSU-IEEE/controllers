...
controllers::map build_real_space_map(){
    // int wallThickness = 3;
    // int mapHeight = 96;
    // int mapWidth = 192;
    //int foot = 24;
    ...
    controllers::map realMap;
    realMap.map(mapHeight, mapWidth);
...
controllers::map build_config_space_map(map &realMap)//int wallThickness, int mapHeight, int mapWidth, int robotSize){
